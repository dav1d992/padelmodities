...
const DA: Dict = {
  ...
  'view.testBanner': 'Prøvekørsel — intet gemmes, og spillernes statistik påvirkes ikke.',
  ...
  'err.draftName': 'Angiv et turneringsnavn for at gemme en kommende turnering.',
...
const EN: Dict = {
  ...
  'view.deleteConfirm': 'Delete the tournament “{name}”? This cannot be undone.',
  ...
  'view.testBanner': 'Test run — nothing is saved and player stats are not affected.',
